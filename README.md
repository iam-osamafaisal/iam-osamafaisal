...
<p align="center">
📍 Bengaluru, India <br>
📩 <b>osamafaisal321@gmail.com</b> <br>
...
- Hands-on with **Linux servers & AWS services**
- Interested in **Cloud Support, Automation & Monitoring**
- Learning by building **real-world DevOps projects**

---

## 🧰 Core Skills
**Linux | AWS | Docker | Jenkins | Git | CI/CD | Networking | Bash**
...
## 🛠️ Projects
- 🔹 **Automated Backup & Log Monitoring** (Linux + AWS)  
- 🔹 **AWS 2-Tier Web Application Deployment**  
- 🔹 **Dockerized Web Application on EC2**
...
**Cloud Support Engineer | Linux Support | DevOps Trainee**
